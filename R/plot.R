...
#' @description Three-dimensional plot of a \code{FEM} object, generated by \code{FEM} or returned by \code{smooth.FEM.time}, \code{smooth.FEM.PDE.basis},
...
plot.mesh.3D<-function(mesh,...){
 ...
 #' @param ... Arguments representing  graphical options to be passed to \link[rgl]{plot3d}.
 #' @description Image plot of a \code{FEM} object, generated by the function \code{FEM} or returned by \code{smooth.FEM.time} can be visualized through an image plot. Only planar mesh (\code{MESH2D}) objects can be plotted with this method.
