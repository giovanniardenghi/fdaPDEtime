...
nodesLocations=matrix(data=hub$nodes, ncol=3, nrow=nnodes, byrow=T) #sar� giusto? o devo distribuire per colonne?

points=eval.FEM(output_CPP$fit.FEM, locations=nodesLocations) # il primo � un NA
...
points2=eval.FEM(output_CPP2$fit.FEM, locations=nodesLocations) # il primo � un NA
